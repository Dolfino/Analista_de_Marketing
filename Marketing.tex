...
%		\input{Conteúdo/15-Carta de Apresentação.tex}
%	\end{carta}
%\end{paracol}
...
\tagline{%
    \begin{profissao}{C}  % Escolha: A, B, C, D, E, F, G, H ou I
        \input{Conteúdo/01-Profissões.tex}
    \end{profissao}
}
...
\personalinfo{%
	...
	\begin{cabecalho}{A}  % A = Fortaleza, B = Caucaia
		\input{Conteúdo/02-Cabeçalho.tex}%
	\end{cabecalho}

	%% Descrição do resumo.
	\cvsubsectionresumo{RESUMO}
	\begin{resumo}{A}  % Escolha: A, B, C, D, E, F, G, H ou I
		\input{Conteúdo/03-Resumo.tex}
	\end{resumo}
	%% Correspondência dos resumos:
...
\begin{formacao}{A}  % Escolha: A, B, C, D, E, F, G, H ou I
    \input{Conteúdo/04-Formação.tex}
\end{formacao}

%--------------------------------------------------------------------------------------
\cvsection{\faAddressCard ~EXPERIÊNCIA PROFISSIONAL}
\begin{profissional}{A}  % Escolha: A, B, C, D, E, F, G, H ou I
\input{Conteúdo/05-Experiência Profissional.tex}
\end{profissional}
...
%\begin{mensagens}{A}  % Escolha: A, B, C, D, E, F, G, H ou I
    %\input{Conteúdo/06-Mensagem.tex}
%\end{mensagens}
%\end{quote}
...
%\input{Conteúdo/Hobbie.tex}

%--------------------------------------------------------------------------------------
%\cvsection{\faMedal HONRA}
%\input{Conteúdo/Honra.tex}

%--------------------------------------------------------------------------------------
%\cvsection{Referências}
%\input{Conteúdo/Referência.tex}
